 ...
 *
 */
package com.example.cardviewactivity.NearbyLocations.GMap;
...
import com.example.cardviewactivity.Adapter.CustomPlacesAdapter;
import com.example.cardviewactivity.Medikit;
import com.example.cardviewactivity.NearbyLocations.GeometryController;
...
public class ListHealthCenters extends AppCompatActivity {
    ...
    void viewMapButton() {
         ...
         * @param MapsActivity
         * */
        Intent intent = new Intent(ListHealthCenters.this, Maps1Activity.class);
