...
public class HomeServiceDialogBoxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_service_dialog_box);
        ...
        new FancyGifDialog.Builder(HomeServiceDialogBoxActivity.this)
                .setTitle(name)
                ...
                .setNegativeBtnBackground(R.color.colorPrimaryDark)
