...
public class MessageTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_message_two);
      ...
      /*  toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MessageTwoActivity.this,DoctorListActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });*/
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!msg.equals(""))
                {
                    ...
                    Toast.makeText(MessageTwoActivity.this, "You Can't Send Empty Message", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
        ...
        firestore.collection("CurrentUser").document(FirebaseAuth.getInstance().getCurrentUser().getUid()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(MessageTwoActivity.this, "Current User Not Found", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot:dataSnapshot.getChildren())
                {
                    ...
                    messageAdapter=new MessageAdapter(MessageTwoActivity.this,mchat,imageurl);
