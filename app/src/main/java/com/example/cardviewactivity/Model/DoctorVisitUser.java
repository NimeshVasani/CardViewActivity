...
public class DoctorVisitUser {

    private String name,expertization,degree,experiance,workplace,time,number;
    private String imageURL;

    public DoctorVisitUser() {
    }

    public DoctorVisitUser(String name, String expertization, String degree, String experiance, String workplace, String time, String number, String imageURL) {
        this.name = name;
