...
package com.example.cardviewactivity.Medical;
...
import com.example.cardviewactivity.Adapter.CustomMedicalProblemsAdapter;
...
public class MedicalProblems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Medikit.progressDialog!=null) Medikit.progressDialog.cancel();
    }
